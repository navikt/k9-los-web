...
import { useKopierKøMutation } from 'fleromrade/api/avdelingslederQueries';
...
const KopierKøModal: React.FC<Props> = ({ lukk, eksisterendeKø }) => {
	...
	const onSubmit = (data: KopierKøFormValues) => {
