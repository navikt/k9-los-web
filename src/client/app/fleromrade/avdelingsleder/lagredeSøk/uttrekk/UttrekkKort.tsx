...
import { UttrekkResultatDialog } from 'fleromrade/avdelingsleder/lagredeSøk/uttrekk/UttrekkResultatDialog';
...
export function UttrekkKort({ uttrekk, lagretSøk }: { uttrekk: Uttrekk; lagretSøk?: LagretSøk }) {
	...
	const csvLenke = useLastNedUttrekkCsvLenke();
				...
				<div className="flex items-center gap-1 flex-shrink-0">
					...
					{kanLasteNed && (
						<>
							...
							<Button as="a" size="small" variant="tertiary" href={csvLenke(uttrekk.id)} icon={<DownloadIcon />}>
								Last ned CSV
							</Button>
						</>
					)}
