const apiPaths = {
	...
	hentLagredeSøkDefaultQuery: '/api/k9-los-api/ny-oppgavestyring/lagret-sok/default-query',
	opprettLagretSøk: '/api/k9-los-api/ny-oppgavestyring/lagret-sok/opprett',
	nyttLagretSøk: '/api/k9-los-api/ny-oppgavestyring/lagret-sok/nytt',
	...
	slettUttrekkForLagretSøk: (lagretSokId: string) =>
	...
	endreUttrekkTittel: (id: string) => `/api/k9-los-api/ny-oppgavestyring/uttrekk/${id}/tittel`,
